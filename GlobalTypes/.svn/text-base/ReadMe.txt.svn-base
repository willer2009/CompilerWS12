========================================================================
    KONSOLENANWENDUNG: GlobalTypes-Projektübersicht
========================================================================

Diese GlobalTypes-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die GlobalTypes-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen GlobalTypes.pch sowie eine vorkompilierte 
